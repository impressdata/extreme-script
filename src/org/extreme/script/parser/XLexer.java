// $ANTLR 2.7.7 (2006-11-01): "x.g" -> "XLexer.java"$
...
public class XLexer extends antlr.CharScanner implements XParserTokenTypes, TokenStream
 {
public XLexer(InputStream in) {
	this(new ByteBuffer(in));
}
public XLexer(Reader in) {
	this(new CharBuffer(in));
}
public XLexer(InputBuffer ib) {
	this(new LexerSharedInputState(ib));
}
public XLexer(LexerSharedInputState state) {
	super(state);
	...
	protected final void mExponent(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		do {
			if (((LA(1) >= '0' && LA(1) <= '9'))) {
				...
				if ( _cnt144>=1 ) { break _loop144; } else {throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());}
			}
