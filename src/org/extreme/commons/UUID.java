...
public class UUID implements java.io.Serializable, Comparable {
	 ...
	 * <p/> The <code>UUID</code> is generated using a cryptographically
	 ...
	 * number describes how this <tt>UUID</tt> was generated. <p/> The version
	 ...
	 * number describes the layout of the <tt>UUID</tt>. <p/> The variant
	 * number has the following meaning:
	 * <p>
	 * <ul>
	...
	/**
	 * The timestamp value associated with this UUID. <p/>
	 * <p>
	...
	/**
	 * The clock sequence value associated with this UUID. <p/>
	 * <p>
	 ...
	 * <p>
	 * <p/> The clockSequence value is only meaningful in a time-based UUID,
	...
	/**
	 * The node value associated with this UUID. <p/>
	 * <p>
	...
	/**
	 * Compares this UUID with the specified UUID. <p/>
	 * <p>
	...
	public int compareTo(Object val) {
		...
		UUID id = (UUID) val;
		return (this.mostSigBits < id.mostSigBits ? -1 : (this.mostSigBits > id.mostSigBits ? 1 : (this.leastSigBits < id.leastSigBits ? -1
				: (this.leastSigBits > id.leastSigBits ? 1 : 0))));
	}
