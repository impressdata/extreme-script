...
public class ArrayUtils {
    ...
    public static boolean isSameArray(Object[] array1, Object[] array2) {
    	...
    	for (int i = 0; i < len1; i++) {
    		if (!ComparatorUtils.equals(array1[i], array2[i])) {
    			return false;
    		}
    	}
    ...
    public static boolean isSameArray(long[] array1, long[] array2) {
    	int len1 = array1 == null ? 0 : array1.length;
    	int len2 = array2 == null ? 0 : array2.length;
    	if (len1 != len2) {
    		return false;
    ...
    public static boolean isSameArray(short[] array1, short[] array2) {
    	int len1 = array1 == null ? 0 : array1.length;
    	int len2 = array2 == null ? 0 : array2.length;
    	if (len1 != len2) {
    		return false;
    ...
    public static boolean isSameArray(boolean[] array1, boolean[] array2) {
    	int len1 = array1 == null ? 0 : array1.length;
    	int len2 = array2 == null ? 0 : array2.length;
    	if (len1 != len2) {
    		return false;
    ...
    public static boolean isSameArray(float[] array1, float[] array2) {
    	int len1 = array1 == null ? 0 : array1.length;
    	int len2 = array2 == null ? 0 : array2.length;
    	if (len1 != len2) {
    		return false;
    ...
    public static boolean isSameArray(double[] array1, double[] array2) {
    	int len1 = array1 == null ? 0 : array1.length;
    	int len2 = array2 == null ? 0 : array2.length;
    	if (len1 != len2) {
    		return false;
